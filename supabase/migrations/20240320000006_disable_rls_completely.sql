...
-- Desabilitar RLS completamente e permanentemente
ALTER TABLE users DISABLE ROW LEVEL SECURITY;

-- Garantir que a tabela users esteja corretamente configurada
ALTER TABLE users FORCE ROW LEVEL SECURITY OFF; 